...
from Algorithms.DT_1D_V4.models.\
        single_phase_multi_species_reactive_pipe_with_uniform_combustion_fraction.\
            single_phase_multi_species_reactive_pipe_with_combustion_fraction_cell \
                import SinglePhaseMultiSpeciesReactivePipeWithCombustionFractionCell

class SinglePhaseMultiSpeciesReactivePipeWithUniformCombustionFraction(SingleInlet1DMeshObject):
    def __init__(self, n_cells, geometry, init_flow_state, comp_label, combustion_fraction, \
        ...
        self.initialise_cells(geometry = geometry, \
                                ...
                                n_cells = n_cells, \
                                combustion_fraction = combustion_fraction)
    ...
    def initialise_cells(self, geometry, init_flow_state, comp_label, n_cells, combustion_fraction):
        [D, L] = geometry
