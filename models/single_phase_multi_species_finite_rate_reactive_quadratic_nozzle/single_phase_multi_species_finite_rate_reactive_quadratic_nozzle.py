...
from Algorithms.DT_1D_V4.models.single_phase_multi_species_finite_rate_reactive_quadratic_nozzle.\
        single_phase_multi_species_finite_rate_reactive_quadratic_nozzle_cell \
                import SinglePhaseMultiSpeciesFiniteRateReactiveQuadraticNozzleCell

class SinglePhaseMultiSpeciesFiniteRateReactiveQuadraticNozzle(SingleInlet1DMeshObject):
    ...
    def initialise_cells(self, geometry, init_flow_state, comp_label, n_cells, shared_reactor_object):
        ...
        for cell in range(n_cells):
            ...
            cell_object = SinglePhaseMultiSpeciesFiniteRateReactiveQuadraticNozzleCell(cell_id = cell, \
                                                                    label = comp_label)
