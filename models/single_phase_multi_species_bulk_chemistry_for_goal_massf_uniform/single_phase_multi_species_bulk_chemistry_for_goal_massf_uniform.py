...
from Algorithms.DT_1D_V4.models.single_phase_multi_species_bulk_chemistry_for_goal_massf_uniform.\
        single_phase_multi_species_bulk_chemistry_for_goal_massf_uniform_cell \
            import SinglePhaseMultiSpeciesBulkChemistryForGoalMassfUniformCell

class SinglePhaseMultiSpeciesBulkChemistryForGoalMassfUniform(SingleInlet1DMeshObject):
    def __init__(self, n_cells, geometry, limiter, comp_label, init_flow_state, \
                    recon_scheme, recon_props, update_from, flux_scheme, \
                    bulk_reaction_parameters, reverse_direction_for_ghost_cells = False):
    ...
    def initialise_cells(self, geometry, init_flow_state, comp_label, n_cells, bulk_reaction_parameters):
        ...
        for cell in range(n_cells):
            ...
            cell_object = SinglePhaseMultiSpeciesBulkChemistryForGoalMassfUniformCell(\
            ...
            cell_object.bulk_reaction_parameters = bulk_reaction_parameters
