...
from Algorithms.DT_1D_V4.models.single_phase_multi_species_nonreactive_elliptic_nozzle.\
        single_phase_multi_species_nonreactive_elliptic_nozzle_cell \
            import SinglePhaseMultiSpeciesNonReactiveEllipticNozzleCell
...
class SinglePhaseMultiSpeciesNonReactiveEllipticNozzle(SingleInlet1DMeshObject):
    ...
    def initialise_cells(self, geometry, init_flow_state, comp_label, n_cells):
        ...
        for cell in range(n_cells):
            ...
            cell_object = SinglePhaseMultiSpeciesNonReactiveEllipticNozzleCell(cell_id = cell, \
                                                                            label = comp_label)
