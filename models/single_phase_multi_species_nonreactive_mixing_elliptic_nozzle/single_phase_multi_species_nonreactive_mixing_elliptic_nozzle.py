...
class SinglePhaseMultiSpeciesNonReactiveMixingEllipticNozzle(SingleInlet1DMeshObject):
    ...
    def initialise_cells(self, geometry, init_flow_state, comp_label, n_cells):
        ...
        for cell in range(n_cells):
            ...
            cell_object = SinglePhaseMultiSpeciesNonReactiveMixingEllipticNozzleCell(cell_id = cell, \
                                                                            label = comp_label)
