...
from Algorithms.DT_1D_V4.models.single_phase_multi_species_reactive_pipe_with_partial_equilibrium_chemistry_cell \
                    import SinglePhaseMultiSpeciesReactivePipeWithPartialEquilibriumChemistryCell

class SinglePhaseMultiSpeciesReactivePipeWithPartialEquilibriumChemistry(SingleInlet1DMeshObject):
    def __init__(self, n_cells, comp_label, geometry, init_flow_state, \
                        partial_equilibrium_fraction, fast_chemistry_fraction, fast_chemistry_gs, \
                        limiter, recon_scheme, recon_props, \
    ...
    def initialise_cells(self, geometry, init_flow_state, comp_label, n_cells, partial_equilibrium_fraction, fast_chemistry_fraction, fast_chemistry_gs):
        [D, L] = geometry
        for cell in range(n_cells):
            ...
            cell_object = SinglePhaseMultiSpeciesReactivePipeWithPartialEquilibriumChemistryCell(cell_id = cell, \
                                                                                    label = comp_label)
            ...
            cell_object.partial_equilibrium_fraction = partial_equilibrium_fraction
