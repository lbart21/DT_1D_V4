...
class SinglePhaseMultiSpeciesReactivePipeWithFastChemistryForGoalMassf(SingleInlet1DMeshObject):
    def __init__(self, n_cells, geometry, init_flow_state, comp_label, combustion_parameters, \
    ...
    def initialise_cells(self, geometry, init_flow_state, comp_label, n_cells, combustion_parameters):
        [D, L] = geometry
        for cell in range(n_cells):
            ...
            cell_object.combustion_parameters = combustion_parameters
