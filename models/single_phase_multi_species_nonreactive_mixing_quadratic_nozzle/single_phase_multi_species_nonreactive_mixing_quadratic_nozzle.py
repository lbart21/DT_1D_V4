...
from Algorithms.DT_1D_V4.models.single_phase_multi_species_nonreactive_mixing_quadratic_nozzle.\
        single_phase_multi_species_nonreactive_mixing_quadratic_nozzle_cell \
            import SinglePhaseMultiSpeciesNonReactiveMixingQuadraticNozzleCell
from Algorithms.DT_1D_V4.models.prefilled_single_inlet_mesh_object import SingleInlet1DMeshObject

class SinglePhaseMultiSpeciesNonReactiveMixingQuadraticNozzle(SingleInlet1DMeshObject):
    ...
    def initialise_cells(self, geometry, init_flow_state, comp_label, n_cells):
        ...
        for cell in range(n_cells):
            ...
            cell_object = SinglePhaseMultiSpeciesNonReactiveMixingQuadraticNozzleCell(cell_id = cell, \
                                                                            label = comp_label)
