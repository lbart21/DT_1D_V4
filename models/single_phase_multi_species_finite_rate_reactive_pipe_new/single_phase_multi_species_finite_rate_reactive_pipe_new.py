...
from Algorithms.DT_1D_V4.models.single_phase_multi_species_finite_rate_reactive_pipe_new.\
        single_phase_multi_species_finite_rate_reactive_pipe_cell_new \
                import SinglePhaseMultiSpeciesFiniteRateReactivePipeCellNew

class SinglePhaseMultiSpeciesFiniteRateReactivePipeNew(SingleInlet1DMeshObject):
    ...
    def initialise_cells(self, geometry, init_flow_state, comp_label, n_cells, shared_reactor_object):
        ...
        for cell in range(n_cells):
            ...
            cell_object = SinglePhaseMultiSpeciesFiniteRateReactivePipeCellNew(cell_id = cell, \
                                                                    label = comp_label)
